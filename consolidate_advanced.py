...
Ejemplos de uso:
  ...
  python %(prog)s --input-dir data --output-dir consolidated --symbols XAUUSD,EURUSD,GBPUSD --year 2023
    ...
    year_group.add_argument('--year', type=int, help='Año individual')
    year_group.add_argument('--start-year', type=int, help='Año inicial para rango')
    year_group.add_argument('--end-year', type=int, help='Año final para rango')
